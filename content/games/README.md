...
1. 게임을 **한 폴더**에 넣습니다 (예: `timing-game/index.html` + `timing-game/style.css`, `timing-game/app.js`).
...
```json
[
  { "file": "timing-game/index.html", "title": "시간 맞추기 게임", "slug": "timing-game" }
]
```
...
예: `timing-game/post-config.json`.  
...
예: `timing-game/screenshots/01-start.png`, `02-play.png`.  
